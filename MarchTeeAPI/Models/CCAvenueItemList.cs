    ...
    public class CCAvenue
    {
        public string CCAvenueItemList
        {
            get
            {
                ...
                dt = (DataTable)HttpContext.Current.Session["CheckedItems"];
                dtClientInfo = (DataTable)HttpContext.Current.Session["ClientInfo"];
                for (int i = 0; i <= dt.Rows.Count - 1; i++)
                {
                    ...
                    string strAmount = dt.Rows[i]["INR"].ToString();
